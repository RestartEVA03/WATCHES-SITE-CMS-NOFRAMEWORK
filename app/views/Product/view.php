                    ...
                    <div class="col-md-5 single-top-left">
                        ...
                        <?php else: ?>
                            <img src="images/<?= $product['img']; ?>"
                                 class="img-responsive col-md-9" alt=""/>
                        <?php endif; ?>

                    </div>
                    <?php
                    $cats = \watchesshop\App::$app->getProperty('cats');
                    $curr = \watchesshop\App::$app->getProperty('currency');
                    ?>
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <h5 class="item_price" id="base-price" data-base="<?= $product->price * $curr['value']; ?>">
                                <?= $curr['symbol_left']; ?><?= $product->price * $curr['value']; ?></h5>
                            <p><?= $product->content; ?></p>
                            <div class="available">
                                <?php if($mods): ?>
                                <ul>
                                        ...
                                        <div class="product-bottom">
                                            ...
                                            <h4>
                                                <a class="item_add add-to-cart-link"
                                                   href="cart/add?id=<?= $item['id']; ?>" data-id="<?= $item['id']; ?>"><i></i>
                                                </a>
                                                <span class=" item_price"><?= $curr['symbol_left']; ?><?= $item['price'] * $curr['value']; ?></span>
                                            </h4>
                                        </div>
